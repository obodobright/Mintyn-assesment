...
import { MobileSidebar } from "@/components/mobileNav/mobileSidebar";
        ...
        <>
            <nav className={styles.navContainer}>
                <nav className={styles.navBody}>
                    <section className={styles.leftNavWrapper}>
                        <div className={styles.logoWrapper}>
                            <FaBars onClick={() => setShowSidebar(!showSidebar)} className={styles.fabars} fontSize={20} color="#1875F0" cursor="pointer" />
                            <Logo />
                        </div>                    <section className={styles.searchWrapper}>
            ...
            {showSidebar && <MobileSidebar hideSidebar={() => setShowSidebar(!showSidebar)} />}
